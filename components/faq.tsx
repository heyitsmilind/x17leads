...
export function Faq() {
  ...
  return (
    <>
      <section id="why-choose-us" className="border-y border-border bg-card/30">
        <div className="mx-auto max-w-5xl px-6 py-20 md:py-24">
          <div className="text-center">
            <h2 className="text-balance text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
              Why Choose x17 Leads
            </h2>
            <p className="mx-auto mt-4 max-w-2xl text-pretty text-lg text-muted-foreground">
              Risk-free pipeline growth backed by domain safety and precision targeting.
            </p>
          </div>

          <div className="mt-12 grid gap-4 md:grid-cols-3">
            {benefits.map((benefit) => (
              <div key={benefit.title} className="rounded-xl border border-border bg-background p-6">
      ...
      <section id="faqs" className="border-b border-border bg-card/30">
